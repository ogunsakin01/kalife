      ...
      <li class="dropdown dropdown-search">
        ...
        <div class="dropdown-menu dropdown-search-container">
          <div class="search-container">
            ...
            <input type="text" placeholder="Enter PNR and hit enter" autocomplete="off">
          </div>
        </div>
        <div class="search-expand-container">
          <span class="ti-search"></span>
          <input type="text" class="expand-search" placeholder="Enter PNR and hit enter" autocomplete="off">
        </div>
      </li>
