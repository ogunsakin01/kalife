<div class="mfp-with-anim mfp-hide mfp-dialog mfp-search-dialog" id="multi-city-dialog">
    <h3>Search for Flight</h3>
    <form>
        <div class="tabbable">
            <ul class="nav nav-pills nav-sm nav-no-br mb10" id="flightChooseTab">
                <li class="active"><a href="#flight-search-1" data-toggle="tab" class="trip_type">MultiCity</a>
                </li>
            </ul>
            <div class="tab-content">
                <div class="tab-pane fade in active" id="flight-search-1">
                    ...
                    <div class="row hidden toHide toHide2">
                        <div class="col-md-4">
                            <div class="form-group form-group-lg form-group-icon-left"><i class="fa fa-map-marker input-icon"></i>
                                <label>From</label>
                                <input class="typeahead form-control departure_airport_multi" id="" value="" placeholder="City, Airport, U.S. Zip" type="text" />
                    ...
                    <div class="row hidden toHide toHide3">
                        <div class="col-md-4">
                            <div class="form-group form-group-lg form-group-icon-left"><i class="fa fa-map-marker input-icon"></i>
                                <label>From</label>
                                <input class="typeahead form-control departure_airport_multi" id="" value="" placeholder="City, Airport, U.S. Zip" type="text" />
        ...
        <button class="btn btn-primary btn-lg search_multi_flight" type="button">Search for Flights</button>
    </form>
</div>
