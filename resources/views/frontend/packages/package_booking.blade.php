...
@section('content')
                                ...
                                <input type="hidden" name="name" value="{{$name}}"/>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="kids" class="form-control package_guests num_of_kids" required>
                                                <option value="0">0</option>
                                                <option value="1">1</option>
                                                <option value="2">2</option>
                                                <option value="3">3</option>
                        ...
                        <li>
                            ...
                            <ul class="booking-item-payment-price">
                                ...
                                <li>
                                    ...
                                    <p class="booking-item-payment-price-amount">&#x20A6; {{number_format($attraction_info->kids_price, 2)}}</p>
                                </li>
                            </ul>
                        </li>
                    <li>
                        @if(auth()->guest())
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>No Of Kids</label>
                                            <input type="number" value="0" disabled="" class="form-control num_of_kid_guests">
    ...
    <script>
        ...
        var kidsHere   = document.getElementsByClassName('num_of_kids');
        if((adultsHere[0].value == 0 ) && (kidsHere[0].value == 0)){
            document.getElementById('package_payment').disabled = true;
        }

        var adultPrice = '{{$attraction_info->adult_price}}';
        var kidPrice = '{{$attraction_info->kids_price}}';
    </script>
@endsection