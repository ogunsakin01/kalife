@extends('layouts.app')
@section('title')Online Payments Record @endsection
@section('onlinePayment') active @endsection
@section('content')
            ...
            <div class="col-md-9">
                ...
                <div class="table-responseive">
                    <table class="table table-bordered table-striped table-booking-history">
                        ...
                        <tbody>
                        @foreach(\App\OnlinePayment::getAllInterswitchTransactionsById(auth()->user()->id) as $i => $transaction)
