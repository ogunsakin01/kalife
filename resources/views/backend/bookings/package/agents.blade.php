...
@section('title') Agents Package Bookings Log @endsection
                    ...
                    <div class=" table-responsive  dataTables_wrapper">
                        <table class="table dataTable ">
                            ...
                            @foreach($bookings as $serial => $booking)
                                @if($role->getUserRole($booking->user_id) === 2)
                                    <tr>
                                        <td>{{$booking->reference}}</td>
                                        <td>{{$user::find($booking->user_id)->agency_name}}</td>
                                        <td>{{$user::find($booking->user_id)->agent_id}}</td>
