...
@section('title') Customers Package Bookings Log @endsection
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card stats-card">
                        ...
                        <div class="stats-ctn">
                            <div class="stats-counter"><span class="counter">{{number_format(($successful_bookings))}}</span></div>
                ...
                <div class="col-md-12">
                    <div class="card stats-card">
                        ...
                        <div class="stats-ctn">
                            <div class="stats-counter"><span class="counter">{{number_format(($failed_bookings))}}</span></div>
                    ...
                    <div class=" table-responsive  dataTables_wrapper">
                        <table class="table dataTable ">
                            ...
                            @foreach($bookings as $serial => $booking)
                                @if($role->getUserRole($booking->user_id) === 1)
                                    <tr>
                                        <td>{{$booking->reference}}</td>
                                        <td>{{$user::find($booking->user_id)->first_name,$user::find($booking->user_id)->last_name}}</td>
