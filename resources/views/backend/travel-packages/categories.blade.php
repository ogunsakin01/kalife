              ...
              <table id="flight_table" class="display table" style="width: 100%;" role="grid" aria-describedby="example_info">
                ...
                @foreach($package_categories as $serial => $package_category)
                  <tr>
                    ...
                    <td>
                      <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#edit_{{$package_category->id}}"><i class="fa fa-edit"></i></button>
                      <button class="btn btn-primary btn-sm activate" data-toggle="tooltip" title="Activate package category" value="{{$package_category->id}}"><i class="fa fa-check"></i></button>
                      <button class="btn btn-danger btn-sm deActivate" data-toggle="tooltip" title="Deactivate package category"  value="{{$package_category->id}}"><i class="fa fa-times"></i></button>
...
@section('javascript')
<script src="{{asset('backend/js/package-categories.js')}}"></script>
@endsection