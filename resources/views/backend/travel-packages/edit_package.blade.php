...
@section('tab-title') Edit {{$package->name}} | Travel Packages @endsection
...
{{$package->name}}{{$package->information}}
    ...
    <div class="row hotel_deal_images hidden">
        ...
        <div class="col-md-3" id="image_{{$hotel_image->id}}">
            <div class="card ecom-grid-item">
                <img class="card-img-top" src="{{asset($hotel_image['image_path'])}}" style="height: 200px; width: 100%" alt="">
                <div class="card-body">
                    <button type="button" class="btn btn-sm btn-danger delete_image" value="{{$hotel_image->id}}"><i class="fa fa-trash"></i> Delete</button>
                </div>
            </div>
        </div>
        @endforeach
    ...
    <div class="row attraction_images hidden">
        @foreach( \App\Gallery::getGalleryByParentId($attraction->id) as $i => $attraction_image)
            <div class="col-md-3" id="image_{{$attraction_image->id}}">
                <div class="card ecom-grid-item">
                    <img class="card-img-top" src="{{asset($attraction_image['image_path'])}}" style="height: 200px; width: 100%" alt="">
                    <div class="card-body">
                        <button type="button" class="btn btn-sm btn-danger delete_image" value="{{$attraction_image->id}}"><i class="fa fa-trash"></i> Delete</button>
                    </div>
                </div>
            </div>
        @endforeach
