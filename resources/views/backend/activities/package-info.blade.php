...
@section('title')New Package Info @endsection
@section('content')
  <div class="row">
    <div class="col-md-12">
    ...
    <div class="col-md-12">
      <div class="card card-white">
        <div class="card-header clearfix">
          <h4 class="card-title"><i class="fa fa-info"></i> Package Information</h4>
        </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    {!! Form::select('package_category_id',\App\PackageCategory::getPackageCategories(), null, ['id'=>'package_category_id', 'class'=> 'form-control', 'placeholder'=>'Choose package category', 'required'=>'required', 'onblur' => "validate()"]) !!}
                  </div>
                  <div class="form-group col-md-6">
                    {!! Form::label('info', 'Package information') !!}
  ...
  <div id="flight_info" class="row">
    <div class="col-md-12">
      <div class="card card-white">
        <div class="card-header clearfix">
          <h4 class="card-title"><i class="fa fa-info"></i> Flight Information</h4>
        </div>
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group col-md-6">
                ...
                {!! Form::text('from_location[]', null, ['class'=> 'form-control', 'id'=>'departure_city', 'placeholder'=>'Choose Departure Airport', 'required'=>'required']) !!}
              </div>
              <div class="form-group col-md-6">
              ...
              <div class="form-group col-md-6">
                ...
                {!! Form::text('departure_date_time[]', null, ['id'=>'datetimepicker1', 'class'=>'form-control', 'placeholder'=>'Select Departure Date & Time', 'required'=>'required']) !!}
              </div>
              <div class="form-group col-md-6">
                {!! Form::label('arrival_date_time', 'Arrival Date & Time') !!}
                {!! Form::text('arrival_date_time[]', null, ['id'=>'datetimepicker2', 'placeholder'=>'Select Arrival Date & Time', 'class'=>'form-control', 'required'=>'required']) !!}
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group col-md-6">
                ...
                {!! Form::text('airline[]', null, ['class'=>'form-control', 'placeholder'=>'Choose Airline', 'required'=>'required']) !!}
              </div>

              <div class="form-group col-md-6">
                {!! Form::label('cabin', 'Cabin') !!}
                {!! Form::select('cabin[]', $cabin, null, ['class'=>'form-control', 'required'=>'required']) !!}
              </div>
            </div>
          </div>
  ...
  <div id="hotel_info" class="row">
    <div class="col-md-12">
      <div class="card card-white">
        <div class="card-header clearfix">
          <h4 class="card-title"><i class="fa fa-info"></i> Hotel Information</h4>
        </div>
        <div class="card-body">
          {!! Form::open(['url'=>'packages', 'method'=>'POST', 'files'=>'true']) !!}
          <div class="row">
  ...
  <div id="attraction_info" class="row">
    <div class="col-md-12">
      <div class="card card-white">
        <div class="card-header clearfix">
          <h4 class="card-title"><i class="fa fa-info"></i> Attraction Information</h4>
        </div>
        <div class="card-body">
          {!! Form::open(['url'=>'packages', 'method'=>'POST', 'files'=>'true']) !!}
          <div class="row">
  ...
  <div id="sight_seeing" class="row">
    <div class="col-md-12">
      <div class="card card-white">
        <div class="card-header clearfix">
          <h4 class="card-title"><i class="fa fa-info"></i> Sight Seeing</h4>
        </div>
        <div class="card-body">
          {!! Form::open(['url'=>'packages', 'method'=>'POST']) !!}
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group col-md-12">
                ...
                {!! Form::textarea('s_description[]', null, ['class'=>'form-control', 'rows'=>2, 'required'=>'required']) !!}
              </div>
            </div>
  ...
  <div id="good_to_know" class="row">
    <div class="col-md-12">
      <div class="card card-white">
        <div class="card-header clearfix">
          <h4 class="card-title"><i class="fa fa-info"></i> Good to Know</h4>
        </div>
        <div class="card-body">
          {!! Form::open(['url'=>'packages', 'method'=>'POST']) !!}
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group col-md-12">
                {!! Form::label('description', 'Description') !!}
                {!! Form::textarea('g_description[]', null, ['class'=>'form-control', 'rows'=>2, 'required'=>'required']) !!}
              </div>
            </div>
          </div>
  ...
  <div id="gallery" class="row">
    <div class="col-md-12">
      <div class="card card-white">
        <div class="card-header clearfix">
          <h4 class="card-title"><i class="fa fa-info"></i> Gallery</h4>
        </div>
        <div class="card-body">
          ...
          {{ Form::hidden('package_id', '', ['id'=>'gallery_id']) }}
          <div class="row">
            <div class="col-md-6">
              <div class="form-group col-md-12">
                <div>
